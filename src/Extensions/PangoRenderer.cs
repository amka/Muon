...
using Markdig.Renderers.Pango;
using Markdig.Renderers.Pango.Inlines;
...
namespace Markdig.Renderers
{
    ...
    public class PangoRenderer : TextRendererBase<PangoRenderer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PangoRenderer"/> class.
        /// </summary>
        /// <param name="writer">The writer.</param>
        public PangoRenderer(TextWriter writer) : base(writer)
        {
        ...
        public PangoRenderer WriteEscape(string content)
        {
        ...
        /// <returns>This instance</returns>
        // [MethodImpl(MethodImplOptionPortable.AggressiveInlining)]
        public PangoRenderer WriteEscape(ref StringSlice slice, bool softEscape = false)
        {
        ...
        /// <returns>This instance</returns>
        // [MethodImpl(MethodImplOptionPortable.AggressiveInlining)]
        public PangoRenderer WriteEscape(StringSlice slice, bool softEscape = false)
        {
        ...
        /// <param name="softEscape">Only escape &lt; and &amp;</param>
        /// <returns>This instance</returns>
        public PangoRenderer WriteEscape(string content, int offset, int length, bool softEscape = false)
        {
        ...
        /// <param name="content">The content.</param>
        /// <returns>This instance</returns>
        public PangoRenderer WriteEscapeUrl(string content)
        {
            if (content == null)
                return this;
        ...
        /// <returns></returns>
        public PangoRenderer WriteAttributes(MarkdownObject obj)
        {
        ...
        /// <returns>This instance</returns>
        public PangoRenderer WriteAttributes(HtmlAttributes attributes, Func<string, string> classFilter = null)
        {
            if (attributes == null)
            {
                return this;
        ...
        /// <param name="softEscape">Only escape &lt; and &amp;</param>
        /// <returns>This instance</returns>
        public PangoRenderer WriteLeafRawLines(LeafBlock leafBlock, bool writeEndOfLines, bool escape, bool softEscape = false)
        {
